    ...
    <div className="relative isolate overflow-hidden bg-hero-pattern xl:bg-[url('/heroimg1.jpg')] max-w-screen bg-cover bg-center h-screen">
      ...
      <div className="mt-[-50px] flex h-screen items-center justify-center">
        <motion.div variants={titleVariants}
          initial="initial"
          whileInView="animate"
           viewport={{ once: true }} className="max-w-full flex-shrink-0 px-4 text-center lg:mx-0 lg:pt-8">
         ...
         Nourish your  
          ...
          <motion.div variants={fadeInAnimationVariants1} className="mt-5 flex items-center justify-center gap-x-6">
            {/* <a
              href="/register"
          ...
          <motion.div variants={fadeInAnimationVariants2}
          ...
          <a href="#products">
            ...
            {/* <i className="icon icon-arrow-down"></i> */}
            <div className="pt-2 pr-1 text-gray-100 ">{ isMobile ? "Swipe" : "Scroll" }</div>
